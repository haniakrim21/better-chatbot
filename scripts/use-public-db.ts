...
async function switchToPublicDB() {
  const headers = {
  ...
  console.log("🔧 SWITCHING TO PUBLIC DATABASE URL\n");
  ...
  // 2. Define Deployment Config Explicitly
  ...
  console.log("🚀 Sending Config Payload (Public DB URL)...");
